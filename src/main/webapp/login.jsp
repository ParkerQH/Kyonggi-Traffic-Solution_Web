...
<body>
<div class="login">
    <img src="resource/images/background.png" alt="login image" class="login__img">
        ...
        <div class="login__content">
            <div class="login__box">
                ...
                <div class="login__box-input">
                    <input type="text" name="id" required class="login__input" id="login-id" placeholder=" " />
                    <label for="login-id" class="login__label">아이디</label>
                </div>
            </div>
            ...
            <div class="login__box">
                ...
                <div class="login__box-input">
                    ...
                    <label for="login-pass" class="login__label">비밀번호</label>
